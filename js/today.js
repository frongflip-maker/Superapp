    ...
    function Today(props) {
        ...
        return (React.createElement("div", { className: "px-4 pt-5 space-y-4" },
            React.createElement("div", { className: "flex items-center justify-between" },
                ...
                React.createElement("button", { onClick: openSettings, "aria-label": "\u0E02\u0E49\u0E2D\u0E21\u0E39\u0E25\u0E41\u0E25\u0E30\u0E41\u0E1A\u0E47\u0E01\u0E2D\u0E31\u0E1E", className: "w-10 h-10 rounded-xl flex items-center justify-center active:scale-90", style: { background: hex(T.surf2, .9), border: `1px solid ${T.border}` } },
                    React.createElement(Settings, { size: 17, style: { color: T.sub } }))),
            (() => {
