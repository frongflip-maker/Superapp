...
function NotificationSettings() {
    ...
    return (React.createElement("div", { className: "mb-4" },
        ...
        subscribed ? (React.createElement("div", { className: "space-y-2" },
            ...
            React.createElement("button", { onClick: test, disabled: busy, className: "w-full py-2.5 rounded-xl font-bold flex items-center justify-center gap-2 active:scale-[.98]", style: { background: T.surf2, color: T.text, border: `1px solid ${T.border}` } }, busy ? "กำลังส่ง…" : "ส่งแจ้งเตือนทดสอบ"))) : (React.createElement("button", { onClick: enable, disabled: busy, className: "w-full py-3 rounded-xl font-bold flex items-center justify-center gap-2 active:scale-[.98]", style: { background: T.purple, color: "#fff" } },
